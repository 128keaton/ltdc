...
%MSX_ROOT%\tools\MSXImage\MSXImage.exe -in %MSX_ROOT%\proj\carwar\data\sprt_pilote.png -out %MSX_ROOT%\proj\carwar\data\sprt_pilote.h -pos 0 0 -size 6 8 -num 8 3 -name pilote   -trans 0x3F574B 
