...
%MSX_ROOT%\tools\Trigo\Trigo.exe -num 256  -shift 8 -bytes 2 sin cos > %MSX_ROOT%\proj\carwar\trigo256.inc
...
%MSX_ROOT%\tools\Trigo\Trigo.exe -num 16   -shift 8 -bytes 1 rot > %MSX_ROOT%\proj\carwar\rot256.inc
%MSX_ROOT%\tools\Trigo\Trigo.exe -num 256  -shift 4 -bytes 1 sqrt > %MSX_ROOT%\proj\carwar\sqrt256.inc
