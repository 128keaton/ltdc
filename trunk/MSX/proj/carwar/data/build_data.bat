...
%CONV% -in %DATA%\cars.png    -out %DATA%\sprt_car_1.h  -pos 0   0  -size 13  11 -num 16 1 -name g_Car1       -trans 0xE300E3 -compress cropline16
%CONV% -in %DATA%\cars.png    -out %DATA%\sprt_car_2.h  -pos 0   11 -size 13  11 -num 16 1 -name g_Car2       -trans 0xE300E3 -compress cropline16 
%CONV% -in %DATA%\cars.png    -out %DATA%\sprt_car_3.h  -pos 0   22 -size 13  11 -num 16 1 -name g_Car3       -trans 0xE300E3 -compress cropline16
%CONV% -in %DATA%\cars.png    -out %DATA%\sprt_car_4.h  -pos 0   33 -size 13  11 -num 16 1 -name g_Car4       -trans 0xE300E3 -compress cropline16
%CONV% -in %DATA%\pilots.png  -out %DATA%\sprt_pilots.h -pos 0   0  -size 6   8  -num 8  3 -name g_Pilots     -trans 0x3F574B -compress cropline16
